...
import { useDeleteTimeEntryById } from "@/api/rest/generated/query/timeentries/timeentries";
...
export default function TimeEntryAdminDeleteForm( { timeentry }: Readonly<TimeEntryAdminDeleteFormProps> ) {
    ...
    const submitHandler = useFormHandler( {
        ...
        onSuccessCallbackAction: () => router.push( "/app/manage/timeentries" ),
