...
} from "@/components/projects/form/custom-fields";
...
function RelatedTimeEntriesFragment( { relatedTimeEntries }: Readonly<{ relatedTimeEntries: TimeEntryDTO[] }> ) {
    return <Field>
...
function TimeEntryFragment(
    { employeeId, total, isRestrictedSearch = true, relatedTimeEntries = [] }:
    Readonly<{
        employeeId: string,
        total: string,
        ...
        <FieldSet>
            ...
            <FieldGroup>
                <div className={ "grid grid-cols-2 gap-16" }>
                    { isRestrictedSearch ?
                        <UserProjectAssignmentLookupField fieldName={ "projectId" }
                        ...
                        :
                        <AdminProjectAssignmentLookupField fieldName={ "projectId" }
                                                           formControl={ form.control }
                                                           disabled={ disabled }
